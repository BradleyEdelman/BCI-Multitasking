...
if ismember(montage,{...
		...
		'BrainProductsMR128',...
		'BrainProductsTMSAuto','BrainProductsTMS64','BrainProductsTMS64PlusEMGx8',...
		'Biosemi128'});
	...
	switch(montage)
		...
		case 'BrainProductsTMS64PlusEMGx8'
			theta = [-90    90   -60    60   -45    45   -60    60   -90    90   -90    90   -90    90   -90    90    45     0    45    112   -31    31   -31    31   -69    69   -69    69  -113   113   -113   113   -49    49   -23    23   -49    49   -74  74   -49    49   -49    49   -74    74   -74    74   -68    68   -74    74   -90    90   -90    90   -90    90   -90    90  90	  22    67    90 nan(1,8)];
			phi = [	 -72    72   -51    51     0     0    51   -51    72   -72   -36    36     0     0    36   -36    90     0   -90   -90   -46    46    46   -46   -21    21    21   -21    18   -18		-18   18   -68    68     0     0    68   -68   -68 68   -29    29    29   -29    68   -68   -41    41     0     0    41   -41   -54    54   -18    18    18   -18    54   -54   90    -90    -90   -90 nan(1,8)];
			numEMGChannels = 8;
	...
	for c=1:numChannels
		...
		if c > numChannels - numEMGChannels
...
elseif strcmp('Lookup',montage)
	EEG=pop_chanedit(EEG, 'lookup','c:\\Users\\cline076\\Documents\\MATLAB\\eeglab13_2_2b\\plugins\\dipfit2.3\\standard_BESA\\standard-10-5-cap385.elp');
