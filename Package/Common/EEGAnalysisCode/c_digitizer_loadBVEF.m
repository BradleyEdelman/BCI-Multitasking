...
% filepath = 'C:\Users\cline076\Dropbox\Research\Hardware\Brainproducts\ActiCAP montages\active electrodes\Unified UOL actiCAP actiCHamp\actiCAP actiCHamp UOL 32 Channel\actiCHamp\CMA-32_NO_REF.bvef';
% filepath = 'C:\Users\cline076\Dropbox\Research\Hardware\Brainproducts\ActiCAP montages\active electrodes\Unified UOL actiCAP actiCHamp\actiCAP actiCHamp UOL 32 Channel\BrainAmp\CMA-32_REF.bvef';
% filepath = 'C:\Users\cline076\Dropbox\Research\Hardware\Brainproducts\ActiCAP montages\active electrodes\actiCAP for LiveAmp 32 Channel\CLA-32.bvef';
filepath = 'C:\Users\cline076\Dropbox\Research\Hardware\Brainproducts\ActiCAP montages\active electrodes\_ARCHIV\actiCAP\actiCAP 32 Channel\AC-32.bvef';

chanlocs = c_digitizer_loadBVEF(filepath);

dm = c_DigitizedMontage('initFromChanlocs',chanlocs);

figure; dm.plot('doLabelElectrodes',true,'doNumberElectrodes',true);
