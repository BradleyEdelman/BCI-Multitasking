...
function raw = createRawFromMontageName()
	...
	c_digitizer_plotData(EEG.chanlocs);
	keyboard
...
function raw = createRawFromEConnectomeLocations()
	tmp=load('C:\Users\cline076\Documents\MATLAB\eConnectome\models\10-X-Locations-On-ColinBemSkin.mat');
	locs = tmp.locations/1e3;
	
	tmp=load('C:\Users\cline076\Documents\MATLAB\eConnectome\models\10-X-Labels.mat');
	labels = tmp.labels;
