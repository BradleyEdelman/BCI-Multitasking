function handle = c_plotSurface(varargin)
	...
	if s.renderingMode > 0
		...
		light('Position',[0 1 1]*2,'Style','infinite','Color',lightColor);
		light('Position',[-1 -1 1]*2,'Style','infinite','Color',lightColor);
		%light('Position',[1 -1 1]*2,'Style','infinite','Color',lightColor);
		light('Position',[0 0 -1]*2,'Style','infinite','Color',lightColor);
		light('Position',[1 -1 1]*2,'Style','infinite','Color',lightColor);
